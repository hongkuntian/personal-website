...
const awsStepFunctions: ExperienceEntry = {
  ...
  highlights: [
    "Modernized alarm infrastructure end to end, consolidating 1,016 managed resources to 75 and cutting synthesis time from 93 to 26 minutes.",
  ...
  detailSections: [
    ...
    },
    {
      ...
      body: [
        "I owned the end-to-end modernization of Step Functions alarm infrastructure, automating deployments, reducing the managed resource count from 1,016 to 75, cutting synthesis time from 93 to 26 minutes, and eliminating redundant per-service paging in migrated regions.",
